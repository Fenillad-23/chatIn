...
class _DashboardState extends State<Dashboard> {
  ...
  LoadPosts() async {
    ...
    if (response['statusCode'] != null ||
      ...
      // print(response['posts'][0][0]['postedBy']);
      for (int i = 0; i < response['posts'].length; i++) {
        // print(response['posts'][i]);
        // dataList.add(response['posts'][i]);
      }
      dataList = response['posts'];
      loaded = true;
      setState(() {});
      // print("print response posted by\n");
      // print(response['posts'][0][0]['postedBy']);
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            dataList[index][index]['postedBy'].toString(),
                            style: TextStyle(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Text(
                        dataList[index][index]['caption'].toString(),
                        style: TextStyle(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          dataList[index][index]['image'][0].toString(),
                          // "https://images.unsplash.com/photo-1640622304233-7335e936f11b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxMXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60",
                          fit: BoxFit.cover,
                        ),
                      ),
